...
<<<<<<< HEAD
import { Navbar, NavbarBrand, NavbarNav, NavItem, NavLink, Mask, View,Dropdown, DropdownToggle, DropdownMenu,  DropdownItem, Fa,Col, MDBDropdownItem, Collapse,NavbarToggler} from 'mdbreact';
=======
import {
  Navbar,
  NavbarBrand,
...
<<<<<<< HEAD
          ...
          <View>
            ...
            <Mask overlay="indigo-light" style={{flexDirection: 'column', height: '100vh'}} className="flex-center  text-white text-center">
=======
          ...
          <View>
            ...
            <Mask overlay="black-light" style={{flexDirection: 'column', height: '100vh'}}
